...
# =================== OWNER - ANL0KE =================== #
ALIVE_NAME = Config.ALIVE_NAME if Config.ALIVE_NAME else "@JAI6H"
...
async def settings(event):
    ...
    await tgbot.send_message(event.chat_id,
                             ...
                             buttons=[
                                     [Button.inline(
                                         "⚜️ العمل بوت مثل هذا ⚜️", data="deployme")]
                             ])
...
async def settings(event):
    await event.delete()
    await event.reply(f"⌔∮ انا مساعد {mention}. الشخصي تستطيع الاتصال بي عن طريق هذا البوت",
                             buttons=[
                                     [Button.inline(
                                         "⚜️ لعمل بوت مثل هذا ⚜️", data="deployme")]
                             ])
...
async def settings(event):
    await event.edit("** ⌔∮ مرحبا بك عزيزي هنا معلومات المطور**:",
                     buttons=[
                         [Button.url("🔗 جيتهاب المطور 🔗", url="https://github.com/JAI6H")],
                         [Button.url("🔗 الجروب الخاص به 🔗", url="https://t.me/GI18H")],
                         [Button.url("🔗 حول المطور 🔗",
                                     url="https://t.me/uu_ak0")]
                     ])
...
async def settings(event):
    if event.sender_id == OWNER_ID:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @JAI6H", alert=True)
