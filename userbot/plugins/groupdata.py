...
async def kickme(leave):
    await leave.edit("⪼ٖ تم مغادره المجموعه بنجاح.")
...
async def _(event):
    if event.fwd_from:
        return
    mentions = "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n** ⪼ المشرفـون في ۿذه المجموعه :** \n"
    reply_message = None
...
async def _(event):
    ...
    async for i in bot.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𝑺𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨  - 𝑮𝑹𝑼𝑶𝑷 𝑺𝑻𝑨𝑻𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
async def fetch_info(chat, event):
    ...
    caption = "<b> 𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨  - 𝑮𝑹𝑼𝑶𝑷 𝑫𝑨𝑻𝑨 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    ...
    if hasattr(chat_obj_info, "scam") and chat_obj_info.scam:
        ...
        caption = f"<b>𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝘿𝙀𝙑 - @JAI6H 𓆪</b>"
    return caption
