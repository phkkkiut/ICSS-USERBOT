...
async def fetch_info(replied_user, event):
    ...
    caption = "<b><i> 𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨 - 𝑷𝑹𝑶 𝑫𝑨𝑻𝑨 𓆪 </i></b>\n"
    caption += f"<b> 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    caption += f"<b> • 🖤 | 𝑵𝑨𝑴𝑬 𓆪</b> {first_name} {last_name}\n"
    caption += f"<b> • 🖤 | 𝑼𝑺𝑹 𓆪</b> {username}\n"
    caption += f"<b> • 🖤 | 𝑰𝑫 𓆪</b> <code>{user_id}</code>\n"
    caption += f"<b> • 🖤 | 𝑵𝑼𝑴𝑩𝑹 𝑷𝑹𝑶 𝑷𝑰𝑪 𓆪</b> {replied_user_profile_photos_count}\n"
    caption += f"<b> • 🖤 | 𝑩𝑰𝑶 ↬ </b> \n {user_bio} \n"
    caption += f"<b> • 🖤 | 𝑷𝑹𝑶 𝑳𝑰𝑵𝑲 𓆪</b> "
    caption += f'<a href="tg://user?id={user_id}">{first_name}</a>'
    caption += f"<b> 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 </b>\n"
    caption += f"<b> 𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𝑫𝑬𝑽 - @GI53H 𓆪 "
