...
C = "**⌔∮ المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    "**⌔∮ قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    "𓆩 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐒𝐨𝐮𝐫𝐜𝐞 - [𝐋𝐢𝐧𝐤](t.me/JAI6H) 𓆪"
)
...
Message = (
"""       ⫷ بوت جافا يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
⫷ @JAI6H - اذا كنت بحاجه الى مساعده فتوجه الى ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين جافا ⫸',
    '⫷ اكتمل تنزيل انلاين جافا بدون اخطاء ⫸',
    '⫷ يتم بدء بوت جافا ⫸',
    '⫷ اكتمل بدء بوت جافا ⫸'
]
