...
ICSS_PIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/0a6ff0e2eee521bba6741.jpg"
)
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "icssbot"
USER_BOT_WARN_ZERO = "**⪼ لقد قمت بتحذيرك من تكرار الرسائل والآن تم حظرك.**\n**- انتظر لحين يعود جافا ويلغي عنك الحظر 🛑.** "
...
if Config.PRIVATE_GROUP_ID != 0:
    ...
    async def approve_p_m(event):
        ...
        APPROVED_PMs = "𓆰 𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨 - 𝑨𝑷𝑷𝑹𝑶𝑽𝑬𝑫𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    ...
    async def do_pm_permit_action(chat_id, event, sender):
        ...
        if PMMENU:
            if Config.CUSTOM_PMPERMIT_TEXT:
                ...
                USER_BOT_NO_WARN = (
                    f"𓆩𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑽𝑨 - 𝑷𝑴 𝑺𝑬𝑪𝑼𝑹𝑰𝑻𝒀𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n❞ مرحبا بك  {mention} ❝\n ⤶ لا ترسل الكثير من الرسائل انتظر حين اعود واسمح لك بالتحدث."
                    f"فقط قل سبب مجيئك ونتظر حتي اعود لكي تتم الموافقه عليك.\
